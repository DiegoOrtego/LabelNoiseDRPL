...
from dataset.ImageNet32_64_dataset import *
...
def data_config(args, transform_train, transform_test, num_classes):
    ...
    if args.method=="ssl" or args.method=="ssl2":
        ...
        trainset, testset, true_labels, labeled_idx, unlabeled_idx, train_noisy_indexes, all_labels = get_dataset_ssl(args, transform_train, transform_test, num_classes)
    ...
    if args.method == "ssl" or args.method == "ssl2":
        return train_loader, test_loader, true_labels, labeled_idx, unlabeled_idx, train_noisy_indexes, trainset, all_labels
    else:
...
def main(args):
    ...
    if args.method == "ssl" or args.method == "ssl2":
        train_loader, test_loader, true_labels, labeled_idx, unlabeled_idx, noisy_indexes, trainset, all_labels = data_config(args, transform_train, transform_test, num_classes)
    else:
        train_loader, test_loader, clean_labels, noisy_labels, noisy_indexes, trainset, all_labels = data_config(args, transform_train, transform_test, num_classes)
    ...
    for epoch in range(1, args.epoch + 1):
        ...
        if args.method == "ssl" or args.method == "ssl2":
            ...
            print('######## Tracking loss ########')
            epoch_losses_train, bmm_model, bmm_model_maxLoss, bmm_model_minLoss = track_training_loss(args, model,
                                                                                                      device,
                                                                                                      train_loader,
                                                                                                      epoch)
